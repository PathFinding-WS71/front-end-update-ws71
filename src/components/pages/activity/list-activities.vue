        ...
        <template #list="slotProps">
          <div class="col-12">
            <div class="flex flex-column xl:flex-row xl:align-items-start p-4 gap-4">
              ...
              <div
                  class="flex flex-column sm:flex-row justify-content-between align-items-start xl:align-items-start flex-1 gap-4">
                ...
                <div class="flex sm:flex-column align-items-center sm:align-items-end gap-2 sm:gap-2">
                  ...
                  <pv-button rounded label="I'll assit!" severity="warning"
