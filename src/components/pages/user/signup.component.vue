          ...
          <div class="form-fields">
            ...
            <div class="form-grid grid">
              ...
              <div class="field col">
                ...
                <pv-password v-model="confirm_password" id="confirm_password" :toggle-mask="true" :feedback="true"
            ...
            <div class="date_selector">
              ...
              <div></div>
              <pv-calendar v-model="birthday" id="birthday" date-format="dd/mm/yy" aria-labelledby="birthday"
                           touch-u-i/>
            </div>
          </div>
